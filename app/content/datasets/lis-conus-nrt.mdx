...
id: lis-conus-nrt
name: LIS CONUS NRT
description: Soil moisture percentiles integrated over various depths for the contiguous United States (CONUS) produced by NASA.

media:
  src: https://placehold.co/2000x1429
